...
- **Rule 4: Rank and Pattern Consistency**: When a GlobalContext is provided, a tensor's usage MUST match its declared rank (number of indices) and index pattern (variance at each position).
